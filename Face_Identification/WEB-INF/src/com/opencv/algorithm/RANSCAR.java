...
public class RANSCAR 
{
	...
	public int homography(String imgsrc,String imgcmp,String fwritepath)
	{
	  ...
	  // Mat img2 = Highgui.imread(secondImageSourcePath, Highgui.CV_LOAD_IMAGE_GRAYSCALE);
	   ...
	   FeatureDetector detector = FeatureDetector.create(FeatureDetector.ORB);//Oriented FAST and Rotated BRIEF
	    DescriptorExtractor descriptor = DescriptorExtractor.create(DescriptorExtractor.ORB);;
	    DescriptorMatcher matcher = DescriptorMatcher.create(DescriptorMatcher.BRUTEFORCE_HAMMING);//Abstract base class for matching keypoint descriptors. It has two groups of match methods: for matching descriptors of an image with another image or with an image set.
	    // First photo
