...
public class ShiftImage 
{
	...
	public static void coloumShift(BufferedImage img,BufferedImage imgx, String xPro,int colorPixelIndex,String shufflingPath,int imgPart,String fileExtension)
	{
		try
		{
			...
			if (xPro == "F") ImageIO.write(I1, "bmp", new File(shufflingPath+"pre_S"+imgColor+imgPart+fileExtension));
			if (xPro == "R") ImageIO.write(I1, "bmp", new File(shufflingPath+"RS"+imgColor+imgPart+fileExtension));
