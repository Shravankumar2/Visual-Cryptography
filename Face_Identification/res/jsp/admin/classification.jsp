...
<head>
    <title>Classification Word List</title>
...
<table id="results" class="tab" align="center" style="width:780px;">
	...
	<tr align="center">
		<th>Select</th>
		<th>Classification Word Name</th>
		<th>Classification Word Remark</th>
	</tr>
<%
		while(rs.next())
		{
...
<%
    ...
    {%>
    	<div class="success" id="message" style="position:absolute;top:10px;left:300px">	
    		<p>Classification Word Details Added Successfully.....!</p>
    	</div>			
    <%}
	if(Utility.parse(request.getParameter("no"))==-1)
	{%>
	...
	{%>
		<div class="success" id="message" style="position:absolute;top:10px;left:300px">	
			<p>Classification Word Details Deleted Successfully.....!</p>
		</div>			
	<%}
	...
	{%>
		<div class="success" id="message" style="position:absolute;top:10px;left:300px">	
			<p>Classification Word Details Updated Successfully....!</p>
		</div>			
	<%}
%>		
</body>
