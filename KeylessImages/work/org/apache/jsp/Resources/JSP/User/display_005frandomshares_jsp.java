...
public final class display_005frandomshares_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	blue_img2 = "blue_div2_"+fileName;
      ...
      out.print(request.getContextPath());
      out.write("/SaveRandomShares\">\r\n");
      out.write("<div align=\"right\" style=\"position:absolute;top:0px;left:510px\">\r\n");
      out.write("    <input type=\"submit\" name=\"submit\" value=\"Cancel\" class=\"gradientbuttons\"/>&nbsp;\r\n");
      out.write("\t<input type=\"submit\" name=\"submit\" value=\"Save Random Share1\" class=\"gradientbuttons\"/>&nbsp;\r\n");
      out.write("\t<input type=\"submit\" name=\"submit\" value=\"Save Random Share2\" class=\"gradientbuttons\"/>\r\n");
      ...
      out.write("\t\t\t<font color=\"#000000\" style=\"font-style: bold\" size=\"5\">Image Encryption Details</font>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t\t                 \t\t<img src=\"");
      out.print(request.getContextPath() );
      out.write("/Resources/Images/arrow.jpg\" width=\"25px\" height=\"20px\"></img>\r\n");
      out.write("\t\t\t\t                 </td>\r\n");
      out.write("\t\t\t\t                 \r\n");
      out.write("\t\t\t\t                 \r\n");
      ...
      out.write("\t\t\t\t                 \t\t<img alt=\"\" src=\"");
      out.print(request.getContextPath());
      out.write("/Files/Division/");
      out.print(red_img1);
      out.write("\" width=\"100px\" height=\"49px\">\r\n");
      out.write("\t\t\t\t                 \t\t<br>\r\n");
      out.write("\t\t\t\t                 \t\t<img alt=\"\" src=\"");
      out.print(request.getContextPath());
      out.write("/Files/Division/");
      ...
      out.print(request.getContextPath());
      out.write("/Files/Division/");
      out.print(green_img1);
      out.write("\" width=\"100px\" height=\"49px\">\r\n");
      out.write("\t\t\t\t                 \t\t<br>\r\n");
      out.write("\t\t\t\t                 \t\t<img alt=\"\" src=\"");
      out.print(request.getContextPath());
      out.write("/Files/Division/");
      out.print(green_img2);
      out.write("\" width=\"100px\" height=\"49px\">\r\n");
      out.write("\t\t\t\t                 \t\t<br>\r\n");
      out.write("\t\t\t\t                 \t\t<img alt=\"\" src=\"");
      out.print(request.getContextPath());
      ...
      out.write("\t\t\t\t                 \t\t<img alt=\"\" src=\"");
      out.print(request.getContextPath());
      out.write("/Files/RandomShare/Share1_");
      out.print(fileName);
      ...
      out.write("\t\t\t\t                 \t\t<img alt=\"\" src=\"");
      out.print(request.getContextPath());
      out.write("/Files/RandomShare/Share2_");
      out.print(fileName);
      out.write("\" width=\"130px\" height=\"130px\">\r\n");
      out.write("\t\t\t\t                 \t\t<br>\r\n");
      out.write("\t\t\t\t                 \t\tSHARE2\r\n");
	...
	if(Utility.parse(request.getParameter("no"))==1)
	{
      ...
      out.write("\t\t\t\t<p>Random Share Generation Process Done Successfully .....</p>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t");
	...
	if(Utility.parse(request.getParameter("no"))==3)
	{
      ...
      out.write("\r\n");
      out.write("\t\t\t<div class=\"success\" id=\"message\" style=\"position:absolute;top:5px;left:50px\">\t\r\n");
      out.write("\t\t\t\t<p>Random Share1 Saved Successfully .....</p>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t");
	...
	if(Utility.parse(request.getParameter("no"))==4)
	{
      ...
      out.write("\r\n");
      out.write("\t\t\t<div class=\"success\" id=\"message\" style=\"position:absolute;top:5px;left:50px\">\t\r\n");
      out.write("\t\t\t\t<p>Random Share2 Saved Successfully .....</p>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t");
