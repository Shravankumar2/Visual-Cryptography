...
<img alt="" src="<%=request.getContextPath()%>/Resources/Images/header2.jpg">
			 ...
			 <tbody><tr>
              ...
              <div id="tabsE">	
                    <ul>
                       ...
                       <li><a href="<%=request.getContextPath()%>/EncryptImage?submit=get" target="myIframe" title="Image Encryption"><span>Encryption</span></a></li>
                     <%--   <li><a href="<%=request.getContextPath()%>/Resources/JSP/User/compose_mail.jsp" target="myIframe" title="Mail The Random Shares"><span>Email</span></a></li> --%>
                       <li><a href="<%=request.getContextPath()%>/Resources/JSP/User/browse_image.jsp" target="myIframe" title="Image Decryption"><span>Decryption</span></a></li>
...
<iframe allowtransparency="true" id="stframe" class="stframe" name="myIframe" frameborder="0" scrolling="no" width="1025px" height="460px"  <%-- src="<%=request.getContextPath()%>/Resources/JSP/Admin/default_page.jsp" --%>>
