...
<p>
	...
	<table id="results" class="tab" border="1" cellpadding="5px" cellspacing="4px" width="860px">
		...
		<tr>
			...
			<font color="#000000" style="font-style: bold" size="5">Decrypted Image Details</font>
			</td>
		...
		<tr align="center">
			...
			<td>
				 <table align="center">
				         <tr>
				                 <td align="center">
				                 		<img alt="" src="<%=request.getContextPath()%>/Files/Decryption/decrepted_img<%=fileExtension%>" width="300" height="200">
				                 		<br>
				                 		Decrypted Image
				                 </td>
				         </tr>
