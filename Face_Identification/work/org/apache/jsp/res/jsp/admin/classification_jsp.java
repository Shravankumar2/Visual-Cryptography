...
public final class classification_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<head>\r\n");
      out.write("    <title>Classification Word List</title>\r\n");
	...
	rs = (ResultSet)request.getAttribute("rs");
      ...
      out.write("\t\t<th>Classification Word Name</th>\r\n");
      out.write("\t\t<th>Classification Word Remark</th>\r\n");
      out.write("\t</tr>\r\n");
	...
	if(Utility.parse(request.getParameter("no"))==1)
    {
      ...
      out.write("    \t\t<p>Classification Word Details Added Successfully.....!</p>\r\n");
      out.write("    \t</div>\t\t\t\r\n");
      out.write("    ");
}
	if(Utility.parse(request.getParameter("no"))==-1)
	...
	if(Utility.parse(request.getParameter("no"))==3)
	{
      out.write("\r\n");
      out.write("\t\t<div class=\"success\" id=\"message\" style=\"position:absolute;top:10px;left:300px\">\t\r\n");
      out.write("\t\t\t<p>Classification Word Details Deleted Successfully.....!</p>\r\n");
      out.write("\t\t</div>\t\t\t\r\n");
      out.write("\t");
}
	...
	if(Utility.parse(request.getParameter("no"))==5)
	{
      out.write("\r\n");
      out.write("\t\t<div class=\"success\" id=\"message\" style=\"position:absolute;top:10px;left:300px\">\t\r\n");
      out.write("\t\t\t<p>Classification Word Details Updated Successfully....!</p>\r\n");
      out.write("\t\t</div>\t\t\t\r\n");
      out.write("\t");
}
