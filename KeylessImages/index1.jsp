...
<img src="<%=request.getContextPath() %>/Resources/Images/header2.jpg"></img>
    	...
    	<div>
    	    <h1> 
	    		<font color="white" size="4"><strong>Admin Login</strong></font>
	    		 ...
	    		 <a href="<%=request.getContextPath() %>/index.jsp"><font color="blue" style="position: absolute;text-align: right;margin-left: 325px;">[Are You User?]</font></a>
	        </h1>
