 ...
 *Dec 10, 2012 3:33:14 PM
 *Project:-KeyLessImageEncryption
...
public class SaveFile extends HttpServlet 
{
	public void service(HttpServletRequest request,HttpServletResponse response)throws IOException
	{
		...
		try
		{
			...
			destFilePath="C:/Users/SHRAVAN KUMAR/Desktop/"+ fileName;
			flag = FileMenipulation.copyFile(srcFilePath, destFilePath,fileName);
