...
/* Add User Details (Starts) */
	...
	public boolean addUserDetails(String username, String password, String name, String email,int department,int designation,String address,String city,String phone,String mobile) 
	{
		boolean flag=false;
		String sql = "";
		try
		{
			...
			connection=dao.connector();
			statement = connection.createStatement();
			sql = "insert into m_user (username,password,u_name,dept_code,design_code,u_address,u_city,u_cell,u_phone,u_email) values('"+username+"','"+password+"','"+name+"','"+department+"','"+designation+"','"+address+"','"+city+"','"+phone+"','"+mobile+"','"+email+"')";
